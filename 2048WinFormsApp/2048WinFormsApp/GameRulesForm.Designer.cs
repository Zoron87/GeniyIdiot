namespace _2048WinFormsApp
{
    partial class GameRulesForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Size = new System.Drawing.Size(335, 121);
            this.label1.TabIndex = 0;
            this.label1.Text = "Используйте клавиши со стрелками для перемещения плитки. Когда две плитки с одина" +
    "ковым номером соприкасаются, они сливаются в одну!";
            // 
            // label2
            // 
            ...
            this.label2.Text = "Правила игры \'2048\'";
            // 
            // GameRulesForm
            // 
